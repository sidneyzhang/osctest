...
public class Login extends BaseJobs {
	...
	public void login() throws Exception {
		...
		// 目标地址
		HttpPost httppost = new HttpPost("http://***/userLogin.do");
		// 传参
		...
		for (String[] u : list) {
			// 查询本月考勤内容
			String logPath = "http://**.cn/timeCard.jsp?nickName=" + u[0]
					+ "&eplTimeCard=" + u[2] + "&begDate="
					+ getFirstDayOfMonth() + "&endDate=" + getLastDayOfMonth();
